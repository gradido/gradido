 ...
 * <div class="col-md-9 showcase_content_area mb-0">
    ...
    <button class="btn btn-outline-warning passphrase-word" type="button">Wörter</button>
  </div>
 ...
 * <div class="col-lg-8 col-md-10 mx-auto alert alert-primary" style="text-align:center">
                          ...
                          <p>Hallo Miau Das sind Wörter einer Passphrase Miau Hilfe Ich mag dich nicht Abenteuer Haus Zoo Garten Ziegel Tisch Auto Husten Hüpfburg Teezeit</p>
                        </div>
 * 
 */
function oninit(vnode) {//vnode.state.disabled = false
