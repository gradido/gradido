...
The configuration of the gradido modules are set and handled by using the package `dotenv`. With this package three different types of configfiles will be treated in a hierachical and dependent manner.

At first the following subchapters describe the configfile types. Afterwards the handling of these files follows.
...
The handling of the different configuration files are part of each gradido module. The `dotenv` package (please see [this link](https://www.npmjs.com/package/dotenv#dotenvx) for more details) treat several `.env`-files in a dependent manner, which is used by the gradido modules like follow
...
A central kind of configuration handling is part of the unix bash script `gradido/deplyment/baremetal/start.sh` and the existing `.env` files in this directory.
...
| **property**                        | **local**                        | **stage-4**                       | **baremetal stage-4**
| ----------------------------------- | -------------------------------- | --------------------------------- |--------------------------------|
| **baremetal .env**                  |                                  |                                   |
...
| KLICKTIPP_PASSWORD                  |                                  |                                   | =
| KLICKTIPP_USER                      |                                  |                                   | =
| META_AUTHOR                         |                                  |                                   | ="Bernd HÃ¼ckstÃ¤dt - Gradido-Akademie"
| META_DESCRIPTION_DE                 |                                  |                                   | ="Dankbarkeit ist die WÃ¤hrung der neuen Zeit. Immer mehr Menschen entfalten ihr Potenzial und gestalten eine gute Zukunft fÃ¼r alle."
...
| META_KEYWORDS_DE                    |                                  |                                   | ="Grundeinkommen, WÃ¤hrung, Dankbarkeit, Schenk-Ã–konomie, NatÃ¼rliche Ã–konomie des Lebens, Ã–konomie, Ã–kologie, Potenzialentfaltung, Schenken und Danken, Kreislauf des Lebens, Geldsystem"
...
| META_TITLE_DE                       |                                  |                                   | ="Gradido â€“ Dein Dankbarkeitskonto"
...
| **frontend**                        |                                  |                                   |
| ADMIN_AUTH_PATH                     | /authenticate?token={token}      | /admin/authenticate?token={token} | /admin/authenticate?token={token}
| ADMIN_AUTH_URL                      | http://localhost:8082            | --                                |
| COMMUNITY_DESCRIPTION               | --                               | Gradido Test Community, Stage 4   | "Gradido Test Community, Stage 4"
| COMMUNITY_HOST                      | --                               | stage4.gradido.net                | stage4.gradido.net
| COMMUNITY_NAME                      | Gradido Entwicklung              | Gradido Test Stage 4              | "Gradido Test Stage 4"
| COMMUNITY_REGISTER_PATH             | --                               | /register                         | /register
| COMMUNITY_REGISTER_URL              | http://localhost:4000/register   |                                   |
| COMMUNITY_SUPPORT_MAIL              | --                               | support@gradido.net               | support@gradido.net
| COMMUNITY_URL                       | http://localhost:4000/           | --                                |
| GMS_ACTIVE                          | --                               | true                              | true
| GRAPHQL_PATH                        | --                               | /graphql                          | /graphql
| GRAPHQL_URI                         | http://localhost:4000/graphql    | --                                | https://stage4.gradido.net/graphql
| FRONTEND_MODULE_HOST                | localhost                        | stage4.gradido.net                | $COMMUNITY_HOST
| FRONTEND_MODULE_PORT                | 3000                             | 3000                              | 3000
| FRONTEND_MODULE_PROTOCOL            | http                             | https                             | https
| HUMHUB_ACTIVE                       | --                               | false                             |
| META_URL                            | http://localhost:4000            | stage4.gradido.net                |
| URL_PROTOCOL                        | --                               | https                             | https
| **admin**                           |                                  |                                   |
| ADMIN_MODULE_HOST                   | localhost                        | stage4.gradido.net                | $COMMUNITY_HOST
| ADMIN_MODULE_PORT                   | 8082                             | 8080                              | 8080
| ADMIN_MODULE_PROTOCOL               | http                             | https                             | https
| COMMUNITY_HOST                      | --                               | stage4.gradido.net                | stage4.gradido.net
| DEBUG_DISABLE_AUTH                  | --                               | false                             |
| GRAPHQL_PATH                        | /graphql                         | /graphql                          | /graphql
| GRAPHQL_URL                         | http://localhost:4000            | --                                |
| URL_PROTOCOL                        | --                               | https                             | https
| WALLET_AUTH_PATH                    | /authenticate?token={token}      | /authenticate?token={token}       | /authenticate?token={token}
| WALLET_LOGIN_PATH                   | /login                           | /login                            | /login
| WALLET_URL                          | http://localhost:3000            | https://stage4.gradido.net        | https://stage4.gradido.net
| **gms_vue**                         |                                  |                                   |
| VUE_APP_API_URL                     | http://localhost:8080            |                                   |
| **backend**                         |                                  |                                   |
| BACKEND_MODULE_HOST                 | localhost                        | localhost                         | localhost
| BACKEND_MODULE_PORT                 | 4000                             | 4000                              | 4000
| BACKEND_MODULE_PROTOCOL             | https                            | http                              | http
| COMMUNITY_DESCRIPTION               | --                               | Gradido Test Community, Stage 4   | "Gradido Test Community, Stage 4"
| COMMUNITY_HOST                      | --                               | stage4.gradido.net                | stage4.gradido.net
| COMMUNITY_NAME                      | --                               | Gradido Test Stage 4              | "Gradido Test Stage 4"
| COMMUNITY_REDEEM_CONTRIBUTION_PATH  | --                               | /redeem/CL-{code}                 | /redeem/CL-{code}
| COMMUNITY_REDEEM_PATH               | --                               | /redeem/{code}                    | /redeem/{code}
| COMMUNITY_REGISTER_PATH             | --                               | /register                         | /register
| COMMUNITY_SUPPORT_MAIL              | --                               | support@gradido.net               | support@gradido.net
| DB_DATABASE                         | gradido_community                | gradido_community                 |
| DB_HOST                             | --                               | localhost                         |
| DB_PASSWORD                         | --                               | jmr2fraXG7Mo8ObED9mGMsoSteK8UWdp  |
| DB_PORT                             | --                               | 3306                              |
| DB_USER                             | --                               | gradido                           |
| DLT_CONNECTOR                       | false                            | false                             | false
| DLT_CONNECTOR_PORT                  | --                               | 6010                              | 6010
| EMAIL                               | --                               | true                              | true
| EMAIL_CODE_REQUEST_TIME             | --                               | 10                                | 10
| EMAIL_CODE_VALID_TIME               | --                               | 1440                              | 1440
| EMAIL_LINK_FORGOTPASSWORD_PATH      | --                               | /forgot-password                  | /forgot-password
| EMAIL_LINK_OVERVIEW_PATH            | --                               | /overview                         | /overview
| EMAIL_LINK_SETPASSWORD_PATH         | --                               | /reset-password/{optin}           | /reset-password/{optin}
| EMAIL_LINK_VERIFICATION_PATH        | --                               | /checkEmail/{optin}{code}         | /checkEmail/{optin}{code}
| EMAIL_PASSWORD                      | --                               | LxWhW8JXqEjy5I1Q22NokWWxqRqSBlNX9OueM8v8jBcOzW6AGyQIodI5 | LxWhW8JXqEjy5I1Q22NokWWxqRqSBlNX9OueM8v8jBcOzW6AGyQIodI5 |
| EMAIL_SENDER                        | --                               | stage4@gradido.net                | stage4@gradido.net
| EMAIL_SMTP_PORT                     | --                               | 587                               | 587
| EMAIL_SMTP_URL                      | --                               | smtp.strato.de                    | smtp.strato.de
| EMAIL_TEST_MODUS                    | --                               | false                             | true
| EMAIL_TEST_RECEIVER                 | --                               | test_team@gradido.net             | stage2@gradido.net
| EMAIL_USERNAME                      | --                               | stage4@gradido.net                | stage4@gradido.net
| FEDERATION_VALIDATE_COMMUNITY_TIMER | true                    | 60000                             | 60000
| FEDERATION_XCOM_SENDCOINS_ENABLED | true                      |                                   | true
| GDT_API_URL                         | false                            | https://gdt.gradido.net           | https://gdt.gradido.net
| GMS_ACTIVE                          | true                             | true                              | true
| GMS_API_URL                         | http://localhost:4044            | https://gms.gradido.net/gms       | https://gms.gradido.net/gms
| GMS_CREATE_USER_THROW_ERRORS        | --                               | false                             | false
| GMS_DASHBOARD_URL                   | http://localhost:8080            | https://gms.gradido.net/          | https://gms.gradido.net/
| GMS_WEBHOOK_SECRET                  | --                               | secret                            | secret
| GRAPHIQL                            | true                             | false                             |
| HUMHUB_ACTIVE                       |                                  | false                             | false
| HUMHUB_API_URL                      |                                  | $HUMHUB_API_URL                   |
| HUMHUB_JWT_KEY                      |                                  | $HUMHUB_JWT_KEY                   |
| JWT_EXPIRES_IN                      | --                               | 10m                               | 10m
| JWT_SECRET                          | --                               | k.A.                              |
| LOGIN_APP_SECRET                    | --                               | 21ffbbc616fe                      |
| LOGIN_SERVER_KEY                    | --                               | a51ef8ac7ef1abf162fb7a65261acd7a  |
| LOG_LEVEL                           | debug                            |                                   | DEBUG
| TYPEORM_LOGGING_RELATIVE_PATH       | --                            | ../deployment/bare_metal/log/typeorm.backend.log | ../deployment/bare_metal/log/typeorm.backend.log
| URL_PROTOCOL                        | --                               | https                             | https
| WEBHOOK_ELOPAGE_SECRET              | --                               | secret                            | secret
| **dht**                             |                                  |                                   |
| COMMUNITY_DESCRIPTION               | --                               | Gradido Test Community, Stage 4   | "Gradido Test Community, Stage 4"
| COMMUNITY_HOST                      | --                               | stage4.gradido.net                | stage4.gradido.net
| COMMUNITY_NAME                      | --                               | Gradido Test Stage 4              | "Gradido Test Stage 4"
...
| DB_PASSWORD                         |                                  | jmr2fraXG7Mo8ObED9mGMsoSteK8UWdp  |
| DB_PORT                             | 3306                             | 3306                              |
| DB_USER                             | root                             | gradido                           |
| DHT_MODULE_PROTOCOL                 | http                             | http                              | http
| DHT_MODULE_HOST                     | localhost                        | localhost                         | localhost
| DHT_MODULE_PORT                     | 5000                             | 5000                              | 6010
| FEDERATION_COMMUNITY_APIS           | 1_0                              | 1_0                               | 1_0
| FEDERATION_COMMUNITY_URL            | http://localhost                 |                                   |
| FEDERATION_DHT_SEED                 |                                  | dd5714667e2e372563265fa79e60957d  |
| FEDERATION_DHT_TOPIC                | GRADIDO_HUB                      | GRADIDO_HUB                       | GRADIDO_HUB
| TYPEORM_LOGGING_RELATIVE_PATH       | typeorm.dht-node.log             | ../deployment/bare_metal/log/typeorm.backend.log | ../deployment/bare_metal/log/typeorm.backend.log
| URL_PROTOCOL                        |                                  | https                             | https
| **federation**                      |----------------------------------|-----------------------------------|
| COMMUNITY_HOST                      |                                  | stage4.gradido.net                | stage4.gradido.net
| DB_DATABASE                         | gradido_community                | gradido_community                 |
...
| DB_PORT                             | 3306                             | 3306                              |
| DB_USER                             |                                  | gradido                           |
| FEDERATION_COMMUNITY_APIS           |                                  | 1_0                               | 1_0
| FEDERATION_MODULE_HOST              | localhost                        | localhost                         | localhost
| FEDERATION_MODULE_PORT              | 5010                             | 5010                              | 5010
| FEDERATION_MODULE_PROTOCOL          | http                             | http                              | http
| GRAPHIQL                            |                                  | false                             |
| LOG_LEVEL                           | --                               | DEBUG                             | DEBUG
| URL_PROTOCOL                        | --                               | https                             | https
| **dlt**                             |                                  |                                   |
| BACKEND_SERVER_URL                  | http://localhost:4000            | http://localhost:4000             |
| DB_DATABASE                         | gradido_dlt                      | gradido_dlt                       |
| DB_DATABASE_TEST                    | gradido_dlt_test                 | gradido_dlt_test                  |
| DB_HOST                             | localhost                        | localhost                         |
| DB_PASSWORD                         |                                  |                                   | 
| DB_PORT                             | 3306                             | 3306                              |
| DB_USER                             | root                             | root                              |
| DLT_CONNECTOR_PORT                  | 6010                             | 6010                              |
| DLT_MODULE_HOST                     | localhost                        | localhost                         |
| DLT_MODULE_PROTOCOL                 | http                             | http                              |
| DLT_MODULE_PORT                     | 6010                             | 6010                              |
| IOTA_API_URL                        | https://chrysalis-nodes.iota.org | https://chrysalis-nodes.iota.org  |
| IOTA_COMMUNITY_ALIAS                | GRADIDO: TestHelloWelt2          | GRADIDO: TestHelloWelt2           |
| IOTA_HOME_COMMUNITY_SEED            | aabbccddeeff00112233445566778899aabbccddeeff00112233445566778899 | aabbccddeeff00112233445566778899aabbccddeeff00112233445566778899 |
| JWT_SECRET                          | secret123                        | secret123                         |
| TYPEORM_LOGGING_RELATIVE_PATH       | typeorm.backend.log           | typeorm.backend.log               | ../deployment/bare_metal/log/typeorm.backend.log
| **gms**                             |                                  |                                   |
| APPLE_AUTH_KEY_URL                  | https://appleid.apple.com/auth/keys | --                             |
| APPLICATION_TITLE                   | Gradido                          | Gradido Mapping Service           |
| APPLICATION_CODE                    | APPCODE                          | APPCODE                           |
| CMK_KEY_ID                          | cd9d9c41-3862-4e5a-ac61-2b9311deadb5 | --                            |
| CMK_KEY_SPEC                        | AES_256                          | --                                |
| COOKIE_PASSWORD                     | 75A0TbY2zuDBpRKxP9VYMv6ZHNZvuzN8 | skaÃ¶dkasÃ¶lue73Sujdfkaas         |
| CRYPTO_KEY                          | UXU4ktjkV20alIpDPelUD6GLKanzWO2U | UXU4ktjkV20alIpDPelUD6GLKanzWO2U  |
| CYPRESS_PROJECT_ID                  | 64r6bg                           | 64r6bg                            |
| DATA_KEY                            | ZXU4ktjkV20alIpDPelUD6GLKanzWO2U | ZXU4ktjkV20alIpDPelUD6GLKanzWO2U  |
| DB_POOL_ACQUIRE                     | 30000                            | 30000                             |
| DB_POOL_IDLE                        | 10000                            | 10000                             |
| DB_POOL_MAX                         | 10                               | 10                                |
| DB_POOL_MIN                         | 1                                | 1                                 |
| DEEPL_TRANSATIONA_API_KEY           | 572003f9-0a30-4c2b-62fb-ff5cd2b9e861 | --                            |
| DEFAULT_COMMUNITY_ROLE              | community                        | community                         |
| DEFAULT_LANGUANGE_CODE              | en                               | en                                |
| DEFAULT_USER_ROLE                   | user                             | user                              |
| EMAIL_PROTOCOL                      | smtp                             | --                                |
| ENABLE_2FA                          | 0                                | --                                |
| ENABLE_API_ENCRYPTION               | 1                                | true                              |
| ENCODING_2FA                        | ascii                            | --                                |
| ENCRYPTION_ALGORITHM                | 'AES-256-CBC'                    | --                                |
| GOOGLE_LOGIN_TOKEN_VALIDATOR        | https://www.googleapis.com/oauth2/v1/tokeninfo?access_token| --     |
| HASH_ROUNDS                         | 5                                | 5                                 |
| INVALID_ATTEMPTS                    | 5                                | 5                                 |
| IV                                  | "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdef" | --                              |
| JWT_ALGO                            | HS256                            | HS256                             |
| JWT_PRIVATE_KEY                     | CKS5gIMIyvVp5vzvmenvP9vW8G2sLQZE | ju74udIS834i89_sadh378            |
| LOG4JS_CONFIG                       | log4js-config.json               | log4js-config.json                |
| LOG_LEVEL                           | debug                            | debug                             | 
| MASTER_CODE                         | 9999                             | 9999                              |
| MASTER_CODE_FLAG                    | true                             | true                              |
| MSG91_AUTH_KEY                      |                                  | --                                |
...
| MYSQL_DATABASE_NAME                 |                                  | gradido_gms                       |
| MYSQL_DEVELOPMENT_DATABASE_NAME     | gradido_gms                 | gradido_gms                       |
| MYSQL_DEVELOPMENT_HOST              | localhost                        | 127.0.0.1                         |
| MYSQL_DEVELOPMENT_PASSWORD          |                                  | yYvybmVu8sxuO2D5PcvO-nQiIZ2fJbMS  |
| MYSQL_DEVELOPMENT_PORT              | 3306                             | 3306                              |
| MYSQL_DEVELOPMENT_USER_NAME         | root                             | gradido                           |
| MYSQL_DIALECT                       | mariadb                          | mariadb                           |
| MYSQL_HOST                          |                                  | http://localhost                  |
| MYSQL_PASSWORD                      |                                  | yYvybmVu8sxuO2D5PcvO-nQiIZ2fJbMS  |
| MYSQL_PORT                          | 3306                             | 3306                              |
| MYSQL_USER_NAME                     |                                  | gradido                           |
| NODE_DB_SETUP                       | 0                                | 0                                 |
| NODE_ENV                            | DEVELOPMENT                      | DEVELOPMENT                       |
| NODE_HOST                           | localhost                        | localhost                         |
| NODE_PORT                           | 4044                             | 3010                              |
| PAGINATION_LIMIT                    | 20                               | 20                                |
| PASSCODE                            | APP_PASS_CODE                    | APP_PASS_CODE                     |
| PROTOCOL                            | http                             | https                             |
| RAZORPAY_PAYMENT_SECRET             | walltpayment                     |                                   |
| S3_ACCESS_KEY=                      |                                  | --                                |
| S3_ACCESS_SECRET                    |                                  | --                                |
...
| SAAS_ENABLED                        | 1                                | --                                |
| SERVER_HOST                         | localhost:4044                   | gms.gradido.net/gms               |
| SES_ACCESS_KEY                      |                                  | --                                |
| SES_ACCESS_SECRET                   |                                  | --                                |
...
| SUPERADMIN_EMAIL                    | admin@illuminz.com               | admin@illuminz.com                |
| SUPERADMIN_PASSWORD                 | admin@illuminz.com               | admin@illuminz.com                |
| TWILIO_ACCOUNT_SID                  |                                  | --                                |
| TWILIO_AUTH_TOKEN                   |                                  | --                                |
| TWILIO_PHONE_NUMBER                 |                                  | --                                |
| TWILIO_SERVICE_SID                  |                                  | --                                |
| USE_FILE_SYSTEM                     | 0                                | --                                |
| USE_S3_BUCKET                       | 1                                | --                                |
| VALID_LANGUANGE_CODES               | en                               | de,en                             |
