Feature: User Authentication - forgot / reset password
  As a user
  ...
  Scenario: Reset password from sign in page successfully
    ...
    Then the user receives am e-mail containing the password reset link
