export enum RIGHTS {
  ...
  ADMIN_CONFIRM_CONTRIBUTION = 'ADMIN_CONFIRM_CONTRIBUTION',
  ADMIN_SEND_ACTIVATION_EMAIL = 'ADMIN_SEND_ACTIVATION_EMAIL',
  ADMIN_LIST_TRANSACTION_LINKS = 'ADMIN_LIST_TRANSACTION_LINKS',
  ADMIN_CREATE_CONTRIBUTION_LINK = 'ADMIN_CREATE_CONTRIBUTION_LINK',
  ADMIN_DELETE_CONTRIBUTION_LINK = 'ADMIN_DELETE_CONTRIBUTION_LINK',
  ADMIN_UPDATE_CONTRIBUTION_LINK = 'ADMIN_UPDATE_CONTRIBUTION_LINK',
  ADMIN_CREATE_CONTRIBUTION_MESSAGE = 'ADMIN_CREATE_CONTRIBUTION_MESSAGE',
  ADMIN_DENY_CONTRIBUTION = 'ADMIN_DENY_CONTRIBUTION',
