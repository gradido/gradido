export enum RIGHTS {
  ...
  CONTRIBUTION_LINK_CREATE = 'CONTRIBUTION_LINK_CREATE',
  CONTRIBUTION_LINK_READ = 'CONTRIBUTION_LINK_READ',
  CONTRIBUTION_LINK_UPDATE = 'CONTRIBUTION_LINK_UPDATE',
  CONTRIBUTION_LINK_DELETE = 'CONTRIBUTION_LINK_DELETE',
}
