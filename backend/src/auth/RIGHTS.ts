export enum RIGHTS {
  ...
  // Federation
  FEDERATE_PUBKEY = 'FEDERATE_PUBKEY',
  FEDERATE_OPEN_CONNECTION = 'FEDERATE_OPEN_CONNECTION',
  FEDERATE_OPEN_CONNECTION_REDIRECT = 'FEDERATE_OPEN_CONNECTION_REDIRECT',
  FEDERATE_OPEN_CONNECTION_ONETIME = 'FEDERATE_OPEN_CONNECTION_ONETIME',
  FEDERATE_REDIRECT = 'FEDERATE_REDIRECT',
}
