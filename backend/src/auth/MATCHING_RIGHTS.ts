...
// data/Module.logic.ts withdraws them while the module is off. A right added to the first
// but not the second would be handed to every logged-in member with the module switched
