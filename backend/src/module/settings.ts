...
// Per-instance switches for optional modules (E-002), stored as a single-row
// singleton (module_settings, id = 1) and flipped by an admin in the admin UI.
//
...
// that actually wants a gated right (see MODULE_RIGHTS and isAuthorized).
