...
import { AppDatabase } from 'database/src/AppDatabase'
...
jest.mock('database/src/AppDatabase')
AppDatabase.getInstance().TransactionsLock().acquire = jest.fn().mockResolvedValue(jest.fn())
*/
