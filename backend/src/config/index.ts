...
const federation = {
  ...
  FEDERATE_COMMUNITY_REDIRECT_URL: process.env.FEDERATE_COMMUNITY_REDIRECT_URL || process.env.FEDERATE_COMMUNITY_URL,
  FEDERATE_COMMUNITY_REDIRECT_PORT: process.env.FEDERATE_COMMUNITY_REDIRECT_PORT || process.env.FEDERATE_COMMUNITY_PORT,
  FEDERATE_COMMUNITY_REDIRECT_ENDPOINT: process.env.FEDERATE_COMMUNITY_REDIRECT_ENDPOINT || 'openConnectionOneTime',
