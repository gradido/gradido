...
static const uint64_t DECAY_POWERS[] = {
    18446743668527564940ULL, 18446743263345587163ULL,
    18446742452981658309ULL, 18446740832253907398ULL,
    18446737590798832767ULL, 18446731107890392267ULL,
    18446718142080346313ULL, 18446692210487594564ULL,
    18446640347411451525ULL, 18446536621696605848ULL,
    18446329172016664620ULL, 18445914279655690837ULL,
    18445084522928643346ULL, 18443425121448271984ULL,
    18440106766335414243ULL, 18433471847125226169ULL,
    18420209169759874097ULL, 18393712435208807257ULL,
    18340833254760868098ULL, 18235530516106764452ULL,
    18026735334708307356ULL, 17616289656815978922ULL,
    16823221487369777986ULL, 15342587292489394070ULL,
    12760787697116905635ULL, 8827449548832185865ULL,
    4224261215193812073ULL,  967345930690427918ULL,
    50727550937131514ULL,    139498028150492ULL,
    1054912443ULL,           0ULL,
};
...
static void r128Mul_precise(R128 *dst, const R128 *a, const R128 *b) {
  ...
  __uint128_t low =
      ((((__uint128_t)a->lo * (__uint128_t)b->lo)) >> 64) + (uint64_t)p1 + (uint64_t)p2;
  dst->lo = (uint64_t)low;
  dst->hi =
      (uint64_t)((p1 >> 64) + (p2 >> 64) + (__uint128_t)a->hi * (__uint128_t)b->hi + (low >> 64));
}
...
grdd_unit grdd_unit_calculate_decay(grdd_unit gdd, grdd_duration_seconds duration) {
  ...
  */
  ...
  // return (grdd_unit)((double)gradidoCent * pow(2.0, (double)-duration /
  ...
  if (negative) { r128Div(&factor, &R128_one, &factor); }
