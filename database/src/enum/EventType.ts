export enum EventType {
  ...
  // ES-021: an administrator switched an account's creation right on or off.
  ADMIN_USER_CREATION_ALLOWED_SET = 'ADMIN_USER_CREATION_ALLOWED_SET',
  ADMIN_USER_SALUTATION_SET = 'ADMIN_USER_SALUTATION_SET',
  ...
  // The first creation (ES-002..ES-019). SKIP is the only trace of a skipped window (the
  // state table holds no row for it); the other three are the outcomes of one process.
  FIRST_CREATION_SKIP = 'FIRST_CREATION_SKIP',
  FIRST_CREATION_DONE = 'FIRST_CREATION_DONE',
  FIRST_CREATION_REVIEW = 'FIRST_CREATION_REVIEW',
  FIRST_CREATION_UNBOOKED = 'FIRST_CREATION_UNBOOKED',
  FIRST_CREATION_TEST = 'FIRST_CREATION_TEST',
  // ES-021: the holder declared the account a project account (creation off), and the
  // holder asked for the creation right back. The second one is also the rate limit of
  // the support mail — one request per day, read from here.
  PROJECT_ACCOUNT_DECLARE = 'PROJECT_ACCOUNT_DECLARE',
  CREATION_RIGHT_REQUEST = 'CREATION_RIGHT_REQUEST',
  ...
  USER_REGISTER_ASSISTED = 'USER_REGISTER_ASSISTED',
  USER_REGISTER_PRESENCE = 'USER_REGISTER_PRESENCE',
