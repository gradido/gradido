...
CREATE TABLE `contributions` (
	...
	`amount_legacy` decimal(40,20) DEFAULT 'NULL',
	`amount_gdd4` bigint(20) DEFAULT 'NULL',
...
CREATE TABLE `contribution_links` (
	...
	`amount_legacy` bigint(20) DEFAULT 'NULL',
	`amount_gdd4` bigint(20) DEFAULT 'NULL',
	`cycle` varchar(12) NOT NULL DEFAULT '''ONCE''',
	`max_per_cycle` int(10) unsigned NOT NULL DEFAULT 1,
	`max_amount_per_month_legacy` bigint(20) DEFAULT 'NULL',
	`max_amount_per_month_gdd4` bigint(20) DEFAULT 'NULL',
	`total_max_count_of_contribution` int(10) unsigned DEFAULT 'NULL',
	`max_account_balance_legacy` bigint(20) DEFAULT 'NULL',
	`max_account_balance_gdd4` bigint(20) DEFAULT 'NULL',
...
CREATE TABLE `pending_transactions` (
	...
	`amount_legacy` decimal(40,20) DEFAULT 'NULL',
	`amount_gdd4` bigint(20) DEFAULT 'NULL',
	`balance_legacy` decimal(40,20) DEFAULT 'NULL',
	`balance_gdd4` bigint(20) DEFAULT 'NULL',
	`balance_date` datetime(3) NOT NULL DEFAULT 'current_timestamp(3)',
	`decay_legacy` decimal(40,20) DEFAULT 'NULL',
	`decay_gdd4` bigint(20) DEFAULT 'NULL',
	`decay_start` datetime(3) DEFAULT 'NULL',
	`decay_calculation_type` int(11) DEFAULT 0,
	`memo` varchar(512) NOT NULL,
	`creation_date` datetime(3) DEFAULT 'NULL',
	`user_id` int(10) unsigned NOT NULL,
...
CREATE TABLE `project_brandings` (
	...
	CONSTRAINT `project_brandings_alias_unique` UNIQUE(`alias`)
);
--> statement-breakpoint
...
CREATE TABLE `transaction_links` (
	...
	`amount_legacy` decimal(40,20) DEFAULT 'NULL',
	`amount_gdd4` bigint(20) DEFAULT 'NULL',
	`hold_available_amount_legacy` decimal(40,20) DEFAULT 'NULL',
	`hold_available_amount_gdd4` bigint(20) DEFAULT 'NULL',
	`memo` varchar(512) NOT NULL,
	`code` varchar(24) NOT NULL,
