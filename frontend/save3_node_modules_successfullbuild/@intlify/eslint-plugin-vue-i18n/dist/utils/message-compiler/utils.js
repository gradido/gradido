...
function getMessageSyntaxVersions(context) {
    ...
    const range = new semver_1.default.Range(messageSyntaxVersion);
    return {
        v8: semver_1.default.intersects(range, '^8.0.0 || <=8.0.0'),
        v9: semver_1.default.intersects(range, '>=9.0.0-0'),
        isNotSet: false,
