...
exports.skipTSAsExpression = exports.getStaticAttributes = exports.isI18nBlock = exports.isVElement = exports.getScriptSetupElement = exports.getVueObjectType = exports.defineCustomBlocksVisitor = exports.getLocaleMessages = exports.getStaticLiteralValue = exports.isStaticLiteral = exports.getDirective = exports.getAttribute = exports.defineTemplateBodyVisitor = void 0;
...
class LocaleDirLocaleMessagesCache {
    constructor() {
        this._targetFilesLoader = new cache_loader_1.CacheLoader((pattern, cwd) => glob_1.default.sync(pattern, { cwd }));
...
function getVueObjectType(context, node) {
    ...
    if (parent.type === 'ExportDefaultDeclaration') {
        const ext = (0, path_1.extname)(context.getFilename()).toLowerCase();
