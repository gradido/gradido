...
class HtmlWebpackPlugin {
    ...
    generateHtmlTags(assets) {
        ...
        if (this.options.preloadStyles.length > 0) {
            head.push({
                tagName: 'link',
                selfClosingTag: selfClosingTag,
                voidTag: true,
                attributes: {
                    rel: 'stylesheet',
                    href: this.options.preloadStyles
                }
            });
        }
        ;
    ...
    injectAssetsIntoHtml(html, assets, assetTags) {
        ...
        if (body.length) {
            ...
            if (this.options.vue) {
                var _preloader = this.options.preloader ? '<img src="preloader.svg"/>' : ''
                body.unshift('<div id="app">' + _preloader + '</div>')
            }
