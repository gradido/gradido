...
#### [2.7.0](https://github.com/gradido/gradido/compare/2.6.1...2.7.0)
...
- switch to bun as turbo packet manager, at last since turbo now support bun, remove yarn from everywhere [`7ae22cb`](https://github.com/gradido/gradido/commit/7ae22cbbe57cd2a3642f513c0a7c3b92c1a3fa70)
- remove hiero use in backend, is moved to dlt-connector [`94224d8`](https://github.com/gradido/gradido/commit/94224d828ebf2db13427ab2be7f9dd1c5e7311dd)
- add hiero topic id to db and admin, check hiero config on backend startup [`1434912`](https://github.com/gradido/gradido/commit/1434912e0aad43dcd182052e06ddea3f201070a5)
...
- make config a own module, detect db version automatic [`169b187`](https://github.com/gradido/gradido/commit/169b18731f6a1c5ba26b3d4a3324499c8e9d2e52)
- update yarn and bun lock files [`31437b1`](https://github.com/gradido/gradido/commit/31437b105dc1c3052c6c54b7c02f21a1ecc8ebe9)
- update to yarn workspaces and turbo [`5173edb`](https://github.com/gradido/gradido/commit/5173edbb39468c1a23a2e9716c3d4228e09f6c16)
...
- add test for circles [`f36eb85`](https://github.com/gradido/gradido/commit/f36eb85411dfdbad86693085dbc9324fc17abc16)
- fix test which will only fail at 31. of month, or 30.05 [`baca224`](https://github.com/gradido/gradido/commit/baca224a2aec890bd1e41febc9a207efec95148c)
- add additional tests for edge cases [`fc137c0`](https://github.com/gradido/gradido/commit/fc137c09b3c8e4a435cd358c24fa19bb085fde36)
...
- add humhub switch and name format, refactor and reuse gms code [`fcd02b6`](https://github.com/gradido/gradido/commit/fcd02b6a9b572a5bd3ff4564a7edb2ba9fd6b201)
- implement humhub export user function [`50aaf0e`](https://github.com/gradido/gradido/commit/50aaf0ea8973f9181cb515243e73618ca6e2e49c)
- merge PublishNameType and GMSPublishNameType [`ac4723e`](https://github.com/gradido/gradido/commit/ac4723ecc58faf49ab8ca7e4da7f2fdaee654759)
...
- refactor [`4e955d8`](https://github.com/gradido/gradido/commit/4e955d8d9512415dcc033229c315b27268efa2c9)
- add gms switch and name type [`03c5669`](https://github.com/gradido/gradido/commit/03c566919cb59203b300d40ec40608b55e426f93)
- add test [`7aa75b0`](https://github.com/gradido/gradido/commit/7aa75b0abd3600b5fce01914b4da01b985b20eb3)
...
- add backendTransaction table, update dltConnectorClient code and test [`ba13144`](https://github.com/gradido/gradido/commit/ba13144ad3ebad781dc4999372e4c3beaf908bb5)
- first draft [`2ff7ade`](https://github.com/gradido/gradido/commit/2ff7adef52312a1086c78596647008fc7843fe4d)
- remove log.txt correct this time [`c97a631`](https://github.com/gradido/gradido/commit/c97a6310c83a09de35b1ab54fa8eeb9660ea7465)
...
- move EmailBuilder out to separat branch [`634a7a7`](https://github.com/gradido/gradido/commit/634a7a7b8b8decb22a4392b03255f2193accf75b)
- move code for update contribution message into context/role/logic/builder classes, reduce double code [`b1d99c5`](https://github.com/gradido/gradido/commit/b1d99c5fb4cc3070dcbecab8227bf015ee90093b)
- refactor contributionMessage with dci [`af1df0f`](https://github.com/gradido/gradido/commit/af1df0fabe425943d8d0ddc5cbcefe1d7ab1a0a3)
...
- shift homecommunity creation for tests in seed directory-tree [`63d7f75`](https://github.com/gradido/gradido/commit/63d7f754e84d244677d994734f5e1f05fb35b910)
- existing homecommunity with uuid as prerequisit for createUser [`315c082`](https://github.com/gradido/gradido/commit/315c08262898de54b342c72666eb35192a702cfd)
- release build 2.0.1 [`5ad90e6`](https://github.com/gradido/gradido/commit/5ad90e6e4dc64e417590f93a7035e0227bef51bb)
...
- first ongoing draft of community-authentication [`841979a`](https://github.com/gradido/gradido/commit/841979a360c538e294e533155892960a6ba46a2e)
- first draft community authentication handshake [`81bf608`](https://github.com/gradido/gradido/commit/81bf608e2bb5fe628a62783dd5f9850e142370e3)
- introduce foreign user in users table [`235773c`](https://github.com/gradido/gradido/commit/235773c9b9fb53e14f8292826b7f2ab7f66e2896)
...
- fix relation, add database diagramm [`e3316a6`](https://github.com/gradido/gradido/commit/e3316a6be7ece47a964237df08334ace9d22794c)
- additional tests for x-com-sendcoins [`fade56a`](https://github.com/gradido/gradido/commit/fade56a55760e60a016db3c09d003ca6018caafe)
- next try x-com-sendCoins [`dfa2a22`](https://github.com/gradido/gradido/commit/dfa2a223db455d8f94ad6bd4acf9211d692b9e00)
...
- additional tests, but still work in progress [`cbefcdc`](https://github.com/gradido/gradido/commit/cbefcdc963cfde21ff986ba507cc9b558cd66d38)
- still work on next testcase... [`17e4969`](https://github.com/gradido/gradido/commit/17e49699ea1c590f9bdc11ae06115a4941575049)
- add dlt_transactions table [`22497e3`](https://github.com/gradido/gradido/commit/22497e38fb4e1ae9d54280f6e6b6879930f9dacf)
...
- setup description for new logfile clearance cronjob [`9cdd6db`](https://github.com/gradido/gradido/commit/9cdd6dbba8c1e8480d5d36c0c7867abfba4e1dd6)
- release v1.23.1, auf stage-2 erzeugt [`54a4a0d`](https://github.com/gradido/gradido/commit/54a4a0d2d9c84c4722dbfd9ba19be50dabcb03da)
- add script to remove log files older than 30 days [`cbb427e`](https://github.com/gradido/gradido/commit/cbb427e3592dbc31fec5becfc0ab30f7cd9b7c39)
...
- copied from dht-node and reduced, added iota hello world test code [`8d4c2ed`](https://github.com/gradido/gradido/commit/8d4c2ed7e68f4452b954f5d0ebe0b062caf29c0d)
- enable all import rules, lint fixes [`208d124`](https://github.com/gradido/gradido/commit/208d1240759dfd0b63a90283126c36be48cecab0)
- add package multiple-cucumber-html-reporter for e2e test reporting [`e342059`](https://github.com/gradido/gradido/commit/e342059dbda8ea4023621580b1f465508b4e43d7)
...
- v.1.22.3 [`11057c4`](https://github.com/gradido/gradido/commit/11057c48f0ca17a88c6fcd538dec3582deb08b67)
- fix email link to have correct url text [`6a440e1`](https://github.com/gradido/gradido/commit/6a440e18b50ad64be084a17b30a6a4e9ab40a3d4)
- fix snapshot [`5657798`](https://github.com/gradido/gradido/commit/5657798016cca199fb7a450d9288c50ca2c33d55)
...
- test case for Moderation Contribution message does not change contribution status, normal message does [`ff03b05`](https://github.com/gradido/gradido/commit/ff03b05e5e0621d7002a9d7c6aa3e9e535049712)
- implicitly test for messagescounts to be correct when moderator message is present(not shown on listContributions) [`f5a761c`](https://github.com/gradido/gradido/commit/f5a761c769b26d28cd126658e3157dcfcd5df75e)
- do not change contribution status on moderator message [`d1ba7c7`](https://github.com/gradido/gradido/commit/d1ba7c7f418fbc6af57cd44c9039de6bee0fd000)
...
- add snapshot for email template testing [`8cc7025`](https://github.com/gradido/gradido/commit/8cc7025bb46d922ac4ea7fbeb753bddb2dc75607)
- remove email template snapshot [`89759f6`](https://github.com/gradido/gradido/commit/89759f607edfdf61cf0e6b02f87b00941aedd80d)
- remove all traces of iota [`98d1002`](https://github.com/gradido/gradido/commit/98d10020119920f11baeade8d0a9a4c72aa80091)
...
- working docker config [`8b39b0f`](https://github.com/gradido/gradido/commit/8b39b0fd4dbcb59f604a40ae67e02054d5eb81d5)
- working docker config [`4209b5e`](https://github.com/gradido/gradido/commit/4209b5e911fdceb0cd36d21d7d0e928cfe2c3973)
- less updates [`e2c2fae`](https://github.com/gradido/gradido/commit/e2c2faeaf05c01b285a4d272ed1695e6d7b64525)
...
- identifier input field [`2320486`](https://github.com/gradido/gradido/commit/2320486d6c64ebbfff5f1ec16ea14c6a83a45cb0)
- validate identifier [`b0fb6f8`](https://github.com/gradido/gradido/commit/b0fb6f88587180cdbbfdb3fc0d9d380372be9363)
- separate validation function for alias, tested [`a82f0cb`](https://github.com/gradido/gradido/commit/a82f0cb2845d0d2649d8177b2e41265d52294a88)
...
- fix alphabetical sort [`9407386`](https://github.com/gradido/gradido/commit/9407386de74172271848057e02639c55ed8ffa75)
- merge [`ae8405e`](https://github.com/gradido/gradido/commit/ae8405e8f688d6a33572684544f76beb0ecf521a)
- add visualize federation [`a1b8be4`](https://github.com/gradido/gradido/commit/a1b8be4329ffc13645d39d2501732dc2fbaf81bf)
...
- Change info.svg to path [`34def5f`](https://github.com/gradido/gradido/commit/34def5fdbf533e93ca2d48495132849cb338649e)
- Unit test moved. [`4c34f09`](https://github.com/gradido/gradido/commit/4c34f0933d62a5430a47c8720bc5e292d65727c7)
- Change following test of tab confirmed. [`44214e9`](https://github.com/gradido/gradido/commit/44214e9657bff28975624268089c95984c71f7c4)
...
- style sidebar, add icons [`a1b926d`](https://github.com/gradido/gradido/commit/a1b926da711215a4b12a51bc66f72632e486f074)
- Set test for adminListAllContributions at the end of the admin szenario. [`62284bd`](https://github.com/gradido/gradido/commit/62284bd0163f5a8536b976a6e83281cd05d7c5e0)
- add svg icons [`fa3dd71`](https://github.com/gradido/gradido/commit/fa3dd714decfb1d8e8742bb4794b7c1fdf891766)
...
- test to 100% [`04fd66d`](https://github.com/gradido/gradido/commit/04fd66dbc4f3b3b9a84fdbc7bfc00cf7129aac03)
- feat(release): Version 1.18.1 [`05f9917`](https://github.com/gradido/gradido/commit/05f9917ac773f58fb88ce93e931cedf0c216b630)
- get it working [`2e18ca4`](https://github.com/gradido/gradido/commit/2e18ca41c9b008198a70c0b23c90b299380becd6)
...
- fix test setup [`f12176c`](https://github.com/gradido/gradido/commit/f12176c35f1e730b28682b915ccbb34109165a33)
- refcator tests for apollo calls [`be65595`](https://github.com/gradido/gradido/commit/be65595bee695c31321617a5b534f071ed34f824)
- localized message [`3b9a553`](https://github.com/gradido/gradido/commit/3b9a553513515d7e4f713b5fb227e0568db790b9)
...
- Equalize en with fr languages. [`a5fd937`](https://github.com/gradido/gradido/commit/a5fd937e14302fc8a3b2ea0c45e3f618e61da2f6)
- refctor link result [`f7b74d8`](https://github.com/gradido/gradido/commit/f7b74d8e63cb39f1ce6c2a6ff1254ffbe0e34354)
- fix tests after new layout [`0f0a5a8`](https://github.com/gradido/gradido/commit/0f0a5a88070bdf7ef062a2de018c374730adf6f3)
...
- review changed from ulf [`183d670`](https://github.com/gradido/gradido/commit/183d670c2a3e5b40eda10d8f5b1a4cdf26d92cbd)
- test error cases for semaphore [`3bf6981`](https://github.com/gradido/gradido/commit/3bf69814cac29040d63c3e6745eff5549fe62b30)
- setup slots for content header and right side [`f5fe88c`](https://github.com/gradido/gradido/commit/f5fe88cffcbfaa768f32c08ad261b6d5807a962b)
...
- separate AdminResolver.test into the corresponding parts [`a2c1b0f`](https://github.com/gradido/gradido/commit/a2c1b0ff963226c7df51b77b645c01292b71a6b7)
- removed text files regarding passphrase [`9b97b6c`](https://github.com/gradido/gradido/commit/9b97b6c40ec108bbc2d3129f2c8f736f2a0e5e90)
- seperate admin resolver into existing resolvers [`db1a11a`](https://github.com/gradido/gradido/commit/db1a11a2b5dba3a159c016c1a30b06419176e4d8)
...
- Upgrade Node in backend from v12.19.0 to v14.20.0 [`d088174`](https://github.com/gradido/gradido/commit/d0881744b5841da34c7d0b037e11de8777a7021f)
- fix: Timezone Problems on Change of Month [`5e2d6c3`](https://github.com/gradido/gradido/commit/5e2d6c3bc90534fef720ac0e1719ebee4a130d3f)
- database migration added [`73ced22`](https://github.com/gradido/gradido/commit/73ced2291e0cff0e0c5263520854ebf7283d244a)
...
- fix test [`1a34db8`](https://github.com/gradido/gradido/commit/1a34db8b1894a757bba2fc5b2ac5953d1c923ad5)
- fix errors [`ee570e9`](https://github.com/gradido/gradido/commit/ee570e9578b21f6bd17be78aad3d2268a02c564f)
- remove depricated test [`dca8763`](https://github.com/gradido/gradido/commit/dca87634722582626c7907edef8dc1937607eb1d)
...
- add env and config for dht topic as switch [`e2efd0d`](https://github.com/gradido/gradido/commit/e2efd0da9d24e13301046eccdbaf9bf62aa9da44)
- parse history message in admin interface [`10eda75`](https://github.com/gradido/gradido/commit/10eda75fb7d619a71b613b3f8045e0922f1d3b7d)
- corrected E-Mail texts [`dcfab11`](https://github.com/gradido/gradido/commit/dcfab11f5e130a1c39f50a9b935ed6bbe1c798e8)
...
- new Page ContributionLink,vue [`3a5f983`](https://github.com/gradido/gradido/commit/3a5f983c5f21e9a8204ec32adc551eae6e56d678)
- more tests, 31st, 28st, 29.02.2024 [`6c8d996`](https://github.com/gradido/gradido/commit/6c8d9966491bef65cd65c497ff7dd1b3fe7402df)
- more tests for all nav-items [`c7c25f2`](https://github.com/gradido/gradido/commit/c7c25f2077ebafb576b4ef2cd1301dc3f61fa833)
...
- tests up and working [`0b68f2f`](https://github.com/gradido/gradido/commit/0b68f2f74b2606128c9d14ae1586e1e59e98fc14)
- fixed tests and negative numbers are now detected [`2fd37a7`](https://github.com/gradido/gradido/commit/2fd37a75038eb0f38c7f0e5d97e0705180471678)
- all tests completed [`a756f0a`](https://github.com/gradido/gradido/commit/a756f0a4cc7c078e106f5c2515864d4196703cdf)
...
- new events fully implemented [`49378c6`](https://github.com/gradido/gradido/commit/49378c64e250beccdf72045eaea6598257d39bd0)
- applied propper conventions and fixed code duplication [`3eae1f6`](https://github.com/gradido/gradido/commit/3eae1f60b292f95e20bccd0da96b670ec9631fa8)
- all conversations solved [`7061718`](https://github.com/gradido/gradido/commit/7061718c1f92aee84ef2c14aeb21055ad59162f9)
...
- set up cypress to utilize cucumber and for tests in typescript [`153b2a2`](https://github.com/gradido/gradido/commit/153b2a2c4e11f35794a875b639d9a58aae97e63a)
- Refactor 'setup.md' to a mark-down file and clearify instructions [`b7c3d2a`](https://github.com/gradido/gradido/commit/b7c3d2acf19c40752c4352373a13b2e620fbb3b0)
- Correct tests after changing login and logout from queries to mutations. [`4461ff9`](https://github.com/gradido/gradido/commit/4461ff92a5d6c5d337003ecb4d751518c187bdab)
...
- fix bug [`f7454e3`](https://github.com/gradido/gradido/commit/f7454e31460b4d6923f81a23a1f17d5be5b1d3ac)
...
- Test that adminCreateContributionMessage, createContributionMessage & listContributionMessages gives the right values back. [`d402b87`](https://github.com/gradido/gradido/commit/d402b871e45e32f4955b9f5ba1eb408bb2fa7db3)
- update language switch unit tests to test for all current availlable languages [`cea6ef6`](https://github.com/gradido/gradido/commit/cea6ef6988862619d43b1c058561dd0d83a82ba4)
- Remove is_moderator from 0047 and moved it to new migration 0048. [`317f318`](https://github.com/gradido/gradido/commit/317f3182feae6cafcd88b9d95a0f79a2a4f178f7)
...
- test commmunity page [`00e3203`](https://github.com/gradido/gradido/commit/00e32036a5c3e84100ce6326deab0b9e87483b1a)
- test contribution list item [`5719884`](https://github.com/gradido/gradido/commit/5719884461123f6d7bad6ac8cf44121361ff3365)
- add updateContribution updateContributionForm [`f3390b7`](https://github.com/gradido/gradido/commit/f3390b7de17db78a57a8bd901a555ad53e7148c0)
...
- add Tests for parameter checks of createContributionLink [`56baf51`](https://github.com/gradido/gradido/commit/56baf51ccdc2779ded71e6652c91b3581aacafe1)
- raise coverage, try to test timers [`b2fff23`](https://github.com/gradido/gradido/commit/b2fff23b6b14fb1c18c64991e315c45cac7fb000)
- Fulfill Moriz suggestions [`91959ae`](https://github.com/gradido/gradido/commit/91959aea287bc1391de67eda5f29faed01da7cee)
...
- changed code for review from wolle [`1a1d71e`](https://github.com/gradido/gradido/commit/1a1d71e52fc4c31abfd4ea54b33d22933bf9baa1)
- quick and dirty confirm contribution link [`232beb8`](https://github.com/gradido/gradido/commit/232beb8bd9c45fff65a6f86d77f73fd49410122b)
- fix test for LanguageSwitch2 [`6210ff8`](https://github.com/gradido/gradido/commit/6210ff8597b678c035676ce8e81806c43ace972c)
...
- fixed stylelint [`6190d68`](https://github.com/gradido/gradido/commit/6190d686f02fda8e142c7222fc46a2445050dba6)
- add component Auth/MobileStart.vue [`cfcbcc9`](https://github.com/gradido/gradido/commit/cfcbcc96a76ccaf35a12291aa1d774a6b217085b)
- Set 28 positive transactions in seeding for bob@baumeister.de [`84a697a`](https://github.com/gradido/gradido/commit/84a697a300e468ae6f75ca0d1f842b6c7a056373)
...
- Add files via upload [`81ad6ff`](https://github.com/gradido/gradido/commit/81ad6ff2d3e997b01188c6c31ec1f74c89e711cd)
...
- Refactor Message tests [`95746a7`](https://github.com/gradido/gradido/commit/95746a732402b7b8d9427c2a3ef52e9f5a035e2c)
- Create Message component [`2974520`](https://github.com/gradido/gradido/commit/29745204b21a55c10d45cb23750b95354c23d381)
- Refactor Message props [`0e0b5ae`](https://github.com/gradido/gradido/commit/0e0b5aef096a72281dce5885369f355d92dfb840)
...
- test update pending creation mutation [`4bf2871`](https://github.com/gradido/gradido/commit/4bf2871ba164744a79d135f9ca8cf18fe09b3409)
- test createPendingCreations [`2e82f00`](https://github.com/gradido/gradido/commit/2e82f007e65d93cceccf7cc4e1ae89e1078256b2)
- test deletePendingCreation and confirmPendingCreation mutations [`76b1763`](https://github.com/gradido/gradido/commit/76b1763bc04ce208a044efddcf6959a8a428e6e5)
...
- remove seed from database [`edaafa0`](https://github.com/gradido/gradido/commit/edaafa0e32110d606957d9e5a2f0370e37d14f40)
- fixed test updateGdt on click on tab [`7cae264`](https://github.com/gradido/gradido/commit/7cae264f1398b26c9ca0dc382c0712698c156372)
- corrected correspondign pages [`5361cc9`](https://github.com/gradido/gradido/commit/5361cc9eb9407dfb6b9596a44e2b3d494bec6b58)
...
- change cols from 0, 12 / 6, 6 zu 1, 11 / 5, 7 [`35d5555`](https://github.com/gradido/gradido/commit/35d5555350d34602a2f7ccb4370d13a14f4ed4af)
- do not emit events. Trigger the events by interactions instead [`c6dcd29`](https://github.com/gradido/gradido/commit/c6dcd29f67e9a5f9c932b6481b9c3c87c1c557b5)
- seed creations months ago from now [`06dcb23`](https://github.com/gradido/gradido/commit/06dcb2380e19892587ac120e4e8420e0162c1be6)
...
- manueller CherryPic aus #1055 [`5c1973a`](https://github.com/gradido/gradido/commit/5c1973a1362c657e475596df4b0c57c9e528b497)
- test transaction link page [`5baa14b`](https://github.com/gradido/gradido/commit/5baa14b359878954a7f598541e8f9c381dfc68cc)
- Test TransactionLinkList [`4637caa`](https://github.com/gradido/gradido/commit/4637caac105458bfe4ef458d596310112c6e5c6a)
...
- get user resolver test running again [`1f3c9d3`](https://github.com/gradido/gradido/commit/1f3c9d39081ebfa4fc5e01d4d755c33372174ba7)
- test delete user component [`980d3cf`](https://github.com/gradido/gradido/commit/980d3cf96a5215466551f2f1e8d805ed8090bcb6)
- avoid moment, use minus signs [`1009075`](https://github.com/gradido/gradido/commit/10090756a13bafdf594dbc16b6af732acf52b1be)
