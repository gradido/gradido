...
#### [v2.11.4](https://github.com/gradido/gradido/compare/v2.11.3...v2.11.4)

- feat(frontend): disable old map [`#3925`](https://github.com/gradido/gradido/pull/3925)
- chore(release): v2.11.3 [`#3924`](https://github.com/gradido/gradido/pull/3924)

#### [v2.11.3](https://github.com/gradido/gradido/compare/v2.11.2...v2.11.3)

> 18 September 2026

- feat(frontend): the avatar shows the user name's letters everywhere [`#3921`](https://github.com/gradido/gradido/pull/3921)
- feat(frontend): the slogan on the printed cards [`#3920`](https://github.com/gradido/gradido/pull/3920)
- feat(frontend): the triads also greet on the address, redeem and assisted register pages [`#3919`](https://github.com/gradido/gradido/pull/3919)
- feat(frontend): three triads take turns above the login and register form [`#3918`](https://github.com/gradido/gradido/pull/3918)
- chore(database): drop the build-phase map and search switches again [`#3917`](https://github.com/gradido/gradido/pull/3917)
- chore(frontend): draw both matching maps with MapLibre alone, without Leaflet [`#3916`](https://github.com/gradido/gradido/pull/3916)
- feat(frontend): draw both matching maps with the engine the admin switch names [`#3915`](https://github.com/gradido/gradido/pull/3915)
- feat(frontend): a MapLibre map engine behind the same seam, not yet wired [`#3914`](https://github.com/gradido/gradido/pull/3914)
- fix(frontend): frame the whole drawn search circle, and a circle round a pole [`#3913`](https://github.com/gradido/gradido/pull/3913)
- refactor(frontend): put a seam between the two maps and Leaflet [`#3912`](https://github.com/gradido/gradido/pull/3912)
- fix(federation): make nullable fields in GetPublicCommunityInfoResult consistent [`#3911`](https://github.com/gradido/gradido/pull/3911)
- feat(frontend): the wallet's own address search field on both maps [`#3910`](https://github.com/gradido/gradido/pull/3910)
- feat(frontend): name the crosshair point from the map's own tiles [`#3909`](https://github.com/gradido/gradido/pull/3909)
- feat(federation): carry the picture date with a cross-community transfer [`#3908`](https://github.com/gradido/gradido/pull/3908)
- feat(backend): keep the picture dates of foreign members current [`#3907`](https://github.com/gradido/gradido/pull/3907)
- feat(backend): relay another community's member pictures to the wallet [`#3906`](https://github.com/gradido/gradido/pull/3906)
- fix(backend): count the full-size picture cap per HTTP request, not per operation [`#3905`](https://github.com/gradido/gradido/pull/3905)
- feat(federation): hand out member pictures to an authenticated peer community [`#3904`](https://github.com/gradido/gradido/pull/3904)
- refactor(backend): model a member's role as 0..1 instead of an array [`#3903`](https://github.com/gradido/gradido/pull/3903)
- feat(frontend): search places with the community's GMS behind the admin switch [`#3902`](https://github.com/gradido/gradido/pull/3902)
- refactor(database): drizzle login query, non-null community uuid, one role per user [`#3896`](https://github.com/gradido/gradido/pull/3896)
- feat(admin): two build-phase switches for the matching map [`#3898`](https://github.com/gradido/gradido/pull/3898)
- fix(frontend): set the newest bookings to the contacts' measure, line for line [`#3897`](https://github.com/gradido/gradido/pull/3897)
- feat(frontend): the mark over a narrowed list says how many bookings [`#3895`](https://github.com/gradido/gradido/pull/3895)
- feat(frontend): say what the supra-regional box does, and which circle the dialog sets [`#3894`](https://github.com/gradido/gradido/pull/3894)
- feat(frontend): a reach switch beside the radius, with a circle of its own [`#3893`](https://github.com/gradido/gradido/pull/3893)
- fix(frontend): draw link rows like bookings, so a phone can read them [`#3892`](https://github.com/gradido/gradido/pull/3892)
- fix(admin): the enlarged picture is a picture, not a dialogue [`#3891`](https://github.com/gradido/gradido/pull/3891)
- feat(admin): the moderation sees the people it works with [`#3890`](https://github.com/gradido/gradido/pull/3890)
- feat(frontend): the moderation dialogue shows faces [`#3889`](https://github.com/gradido/gradido/pull/3889)
- fix(backend): the contribution thread only opens for the member it belongs to [`#3888`](https://github.com/gradido/gradido/pull/3888)
- feat(frontend): the bookings column carries every memo's first line, and creations [`#3887`](https://github.com/gradido/gradido/pull/3887)
- fix(frontend): a long memo no longer widens the page, and on the desk it ends at the amount [`#3886`](https://github.com/gradido/gradido/pull/3886)
- fix(frontend): on the phone the amount keeps a share of its line, the arrow beside it [`#3885`](https://github.com/gradido/gradido/pull/3885)
- fix(frontend): memos are shown as text, and stand in the booking row [`#3884`](https://github.com/gradido/gradido/pull/3884)
- feat(frontend): every list of people draws its faces at one size, 48 [`#3883`](https://github.com/gradido/gradido/pull/3883)
- refactor(database): translate some user contacts queries into drizzle [`#3882`](https://github.com/gradido/gradido/pull/3882)
- feat(frontend): the right-hand column draws bookings and contacts to one measure [`#3881`](https://github.com/gradido/gradido/pull/3881)
- refactor(database): move user contacts typeorm queries into database [`#3880`](https://github.com/gradido/gradido/pull/3880)
- feat(frontend): one column on the phone map, and no community point on the home tab [`#3879`](https://github.com/gradido/gradido/pull/3879)
- fix(frontend): the map page keeps its place between 992 and 1070 px [`#3878`](https://github.com/gradido/gradido/pull/3878)
- feat(frontend): the map's way back joins the search line, and the dark map gets dark controls [`#3877`](https://github.com/gradido/gradido/pull/3877)
- feat(frontend): the profile window says why somebody matches [`#3876`](https://github.com/gradido/gradido/pull/3876)
- feat(frontend): the grey rings and the silent lines open the profile, and a match shows the whole person [`#3875`](https://github.com/gradido/gradido/pull/3875)
- feat(frontend): the fifth step on the map, and breadth counts things, not pairs [`#3874`](https://github.com/gradido/gradido/pull/3874)
- refactor(database): move complex user queries into database [`#3873`](https://github.com/gradido/gradido/pull/3873)
- fix(frontend): give every map marker a 44 px tap area [`#3872`](https://github.com/gradido/gradido/pull/3872)
- fix(frontend): a 401 is not a refusal, a log is not a diary, a sweep runs at sign-out [`#3870`](https://github.com/gradido/gradido/pull/3870)
- chore(release): v2.11.2 [`#3871`](https://github.com/gradido/gradido/pull/3871)
- fix(backend): a position is two numbers, on the way in and on the way out [`#3869`](https://github.com/gradido/gradido/pull/3869)

#### [v2.11.2](https://github.com/gradido/gradido/compare/v2.11.1...v2.11.2)

> 10 September 2026

- fix(frontend): the map remembers per account, not per device [`#3868`](https://github.com/gradido/gradido/pull/3868)
- fix(frontend): the find map opens only with a position and permission [`#3867`](https://github.com/gradido/gradido/pull/3867)
- feat(frontend): the offer to keep a search becomes one line at the bottom [`#3866`](https://github.com/gradido/gradido/pull/3866)
- feat(frontend): the offers read the way the words are written [`#3865`](https://github.com/gradido/gradido/pull/3865)
- feat(frontend): the search field offers the words it could be finished with [`#3864`](https://github.com/gradido/gradido/pull/3864)
- feat(frontend): the typed search has one field, the particulars line is gone [`#3863`](https://github.com/gradido/gradido/pull/3863)
- feat(frontend): a question typed on the map goes to the GMS typed search [`#3862`](https://github.com/gradido/gradido/pull/3862)
- feat(frontend): the glow map reads the GMS routes instead of the stub [`#3861`](https://github.com/gradido/gradido/pull/3861)
- feat(backend): two ticks that exclude each other go to a moderator [`#3860`](https://github.com/gradido/gradido/pull/3860)
- feat(frontend): the first-creation window explains itself and keeps its own footer [`#3859`](https://github.com/gradido/gradido/pull/3859)
- feat(other): the comment mail stops offering a reply where none is possible [`#3858`](https://github.com/gradido/gradido/pull/3858)
- feat(backend): the sentence in the box belongs to the member, whole [`#3857`](https://github.com/gradido/gradido/pull/3857)
- feat(other): a child can tick a box of their own [`#3856`](https://github.com/gradido/gradido/pull/3856)
- feat(frontend): the first-creation window, after the second run [`#3855`](https://github.com/gradido/gradido/pull/3855)
- feat(frontend): switching creation off takes a typed confirmation, switching back a confirmed request [`#3854`](https://github.com/gradido/gradido/pull/3854)
- feat(backend): the project account - a column that takes the creation rights away (ES-021) [`#3853`](https://github.com/gradido/gradido/pull/3853)
- feat(backend): the function test reopens the first creation for an admin [`#3852`](https://github.com/gradido/gradido/pull/3852)
- fix(frontend): the first-creation window after its first real use [`#3850`](https://github.com/gradido/gradido/pull/3850)
- fix(backend): real umlauts in the German Crea is shown [`#3851`](https://github.com/gradido/gradido/pull/3851)
- feat(frontend): the first-creation window - catalog, wait, ticks and message (L2) [`#3849`](https://github.com/gradido/gradido/pull/3849)
- feat(backend): the first creation - data model, interaction, Crea lines and signer setting (L1) [`#3848`](https://github.com/gradido/gradido/pull/3848)
- refactor(backend): lift the contribution cores out of their resolvers [`#3847`](https://github.com/gradido/gradido/pull/3847)
- fix(frontend): the local-currency remainder survives an edited amount [`#3846`](https://github.com/gradido/gradido/pull/3846)
- fix(frontend): drop the dead ellipsis prop everywhere and keep the contacts pager on one row [`#3845`](https://github.com/gradido/gradido/pull/3845)
- fix(frontend): the heart stands beside the member, not beside the booking [`#3844`](https://github.com/gradido/gradido/pull/3844)
- fix(frontend): the heart in the last-bookings column stops wandering [`#3843`](https://github.com/gradido/gradido/pull/3843)
- feat(frontend): a tap on a member opens the contact window everywhere [`#3842`](https://github.com/gradido/gradido/pull/3842)
- feat(frontend): the contact window leads to the bookings shared with that member [`#3841`](https://github.com/gradido/gradido/pull/3841)
- feat(frontend): the long tab gets two thirds, and the contact window a close cross [`#3840`](https://github.com/gradido/gradido/pull/3840)
- chore(release): v2.11.1 [`#3839`](https://github.com/gradido/gradido/pull/3839)

#### [v2.11.1](https://github.com/gradido/gradido/compare/v2.11.0...v2.11.1)

> 3 September 2026

- feat(frontend): the switch over the right-hand column becomes its heading [`#3837`](https://github.com/gradido/gradido/pull/3837)
- fix(frontend): the zoom overlay stops styling the whole wallet [`#3838`](https://github.com/gradido/gradido/pull/3838)
- feat(frontend): the contacts column, the phone strip and the contact window [`#3836`](https://github.com/gradido/gradido/pull/3836)
- feat(frontend): contacts and favourites, delivery 1 of 2 [`#3835`](https://github.com/gradido/gradido/pull/3835)
- fix(frontend): the Dutch wallet siezt in one line and duzt in 229 [`#3834`](https://github.com/gradido/gradido/pull/3834)
- feat(admin): translate the Crea settings page into the eight other languages [`#3833`](https://github.com/gradido/gradido/pull/3833)
- test(backend): hold the front ends' documents and the Crea guards to the schema [`#3832`](https://github.com/gradido/gradido/pull/3832)
- feat(admin): split the Crea page in two, and stop keying at the next batch [`#3831`](https://github.com/gradido/gradido/pull/3831)
- feat(admin): a checkbox for whether Crea keys matching entries [`#3830`](https://github.com/gradido/gradido/pull/3830)
- feat(backend): work out the words a matching entry can be found under [`#3829`](https://github.com/gradido/gradido/pull/3829)
- fix(frontend): shorten the outdated-app notice so it fits one line on a phone [`#3827`](https://github.com/gradido/gradido/pull/3827)
- feat(frontend): tell an open wallet that a newer build is being served [`#3826`](https://github.com/gradido/gradido/pull/3826)
- fix(frontend): the booking list opens at page one, and the overview stops following it [`#3825`](https://github.com/gradido/gradido/pull/3825)
- feat(frontend): tapping a member picture opens it at full size [`#3824`](https://github.com/gradido/gradido/pull/3824)
- chore(release): v2.11.0 [`#3822`](https://github.com/gradido/gradido/pull/3822)
- feat(backend): fine tune gms export users request per seconds [`#3823`](https://github.com/gradido/gradido/pull/3823)

#### [v2.11.0](https://github.com/gradido/gradido/compare/v2.10.1...v2.11.0)

> 29 August 2026

- fix(frontend): correct three defects in the wallet texts [`#3731`](https://github.com/gradido/gradido/pull/3731)
- fix(backend): the veto link in the notice to the old address stays reliable [`#3821`](https://github.com/gradido/gradido/pull/3821)
- refactor(backend): send users and matching entries separat [`#3810`](https://github.com/gradido/gradido/pull/3810)
- feat(other): replicate more often that AI marker is for new files only [`#3820`](https://github.com/gradido/gradido/pull/3820)
- fix(frontend): the settings page shows the address in force, not the one signed in with [`#3819`](https://github.com/gradido/gradido/pull/3819)
- perf(database): index the two contact columns every request reaches through [`#3818`](https://github.com/gradido/gradido/pull/3818)
- fix(backend): every path that moves a pending change runs under one lock [`#3817`](https://github.com/gradido/gradido/pull/3817)
- fix(frontend): the wallet's dead links, and the test that could not see them [`#3816`](https://github.com/gradido/gradido/pull/3816)
- fix(backend): a typed-in address yields, and asking again buys no second window [`#3812`](https://github.com/gradido/gradido/pull/3812)
- refactor(frontend): the right-hand column is a property of the route, not of its path [`#3815`](https://github.com/gradido/gradido/pull/3815)
- fix(frontend): the balance switch reads its value once, and the refetch reads a section [`#3814`](https://github.com/gradido/gradido/pull/3814)
- fix(frontend): the name fits the card, the amount fits the column, and the balance toggle stays quiet [`#3813`](https://github.com/gradido/gradido/pull/3813)
- feat(frontend): the booking list only on the overview, and a business card without the real name [`#3811`](https://github.com/gradido/gradido/pull/3811)
- fix(backend): an unconfirmed address cannot be held for good, and a stranded code is not a way in [`#3806`](https://github.com/gradido/gradido/pull/3806)
- fix(frontend): let the rules start at the label, and drop a badge that meant something else [`#3809`](https://github.com/gradido/gradido/pull/3809)
- fix(backend): dangling connections after tests [`#3808`](https://github.com/gradido/gradido/pull/3808)
- fix(frontend): test which broke on dev system, but works in ci [`#3807`](https://github.com/gradido/gradido/pull/3807)
- feat(backend): the mails name a third party by alias, not by real name [`#3805`](https://github.com/gradido/gradido/pull/3805)
- perf(frontend): stop the avatar preview stuttering, and drop the toast over it [`#3804`](https://github.com/gradido/gradido/pull/3804)
- feat(frontend): take the avatar photo with the camera, and turn or mirror it [`#3803`](https://github.com/gradido/gradido/pull/3803)
- feat(backend): members are known by their alias, not their real name [`#3802`](https://github.com/gradido/gradido/pull/3802)
- feat(backend): assisted registration - the doorbell flow of EM-013 [`#3801`](https://github.com/gradido/gradido/pull/3801)
- fix(frontend): give the settings their room, and their buttons their colours [`#3800`](https://github.com/gradido/gradido/pull/3800)
- feat(backend): members can change back to an address they held before [`#3799`](https://github.com/gradido/gradido/pull/3799)
- fix(frontend): login button after an e-mail change carried a redeem code [`#3798`](https://github.com/gradido/gradido/pull/3798)
- fix(frontend): halve the heading clearance and keep the special keys' ink on hover [`#3797`](https://github.com/gradido/gradido/pull/3797)
- fix(frontend): give the page heading back the room the navbar took [`#3796`](https://github.com/gradido/gradido/pull/3796)
- feat(frontend): the calculator follows the light/dark switch [`#3795`](https://github.com/gradido/gradido/pull/3795)
- fix(other): one form of address per language in the mails [`#3794`](https://github.com/gradido/gradido/pull/3794)
- fix(other): no "paid" in the thank-you card receipt [`#3793`](https://github.com/gradido/gradido/pull/3793)
- fix(other): keep the line breaks a person typed in every mail [`#3792`](https://github.com/gradido/gradido/pull/3792)
- fix(other): let the mails reply buttons lead into the wallet [`#3791`](https://github.com/gradido/gradido/pull/3791)
- fix(other): restore the card width that box-sizing had quietly taken [`#3790`](https://github.com/gradido/gradido/pull/3790)
- fix(other): mark the message card with a mid-grey edge instead of a darker fill [`#3789`](https://github.com/gradido/gradido/pull/3789)
- fix(other): keep the message card and the reply button visible in dark mode [`#3788`](https://github.com/gradido/gradido/pull/3788)
- fix(other): make the email header a transparent png so dark mode matches [`#3787`](https://github.com/gradido/gradido/pull/3787)
- feat(frontend): make the settings look like settings [`#3786`](https://github.com/gradido/gradido/pull/3786)
- fix(other): paint email card backgrounds with a colour, not a gradient [`#3785`](https://github.com/gradido/gradido/pull/3785)
- feat(frontend): give the settings a menu and one address per area [`#3784`](https://github.com/gradido/gradido/pull/3784)
- feat(frontend): make the wallet installable on the home screen [`#3783`](https://github.com/gradido/gradido/pull/3783)
- feat(frontend): the receipt names the remainder, and the page heading steps aside [`#3782`](https://github.com/gradido/gradido/pull/3782)
- feat(frontend): business card, till-tool placement, and the camera prompt [`#3781`](https://github.com/gradido/gradido/pull/3781)
- feat(frontend): show the member own codes, and stop calling it a payment [`#3780`](https://github.com/gradido/gradido/pull/3780)
- feat(backend): members can change their e-mail address [`#3779`](https://github.com/gradido/gradido/pull/3779)
- feat(frontend): the till cycle closes inside the wallet [`#3778`](https://github.com/gradido/gradido/pull/3778)
- feat(frontend): qr scanner in the wallet [`#3776`](https://github.com/gradido/gradido/pull/3776)
- refactor(workflow): native file change check instead of separate job [`#3775`](https://github.com/gradido/gradido/pull/3775)
- fix(backend): the card pin no longer costs a slot in the login queue [`#3774`](https://github.com/gradido/gradido/pull/3774)
- feat(frontend): the calculator fills the screen and hands its sums onward [`#3773`](https://github.com/gradido/gradido/pull/3773)
- feat(frontend): a calculator page that hands its result to the card payment [`#3771`](https://github.com/gradido/gradido/pull/3771)
- fix(frontend): the avatar colour that moved, and the tests that could not see it [`#3772`](https://github.com/gradido/gradido/pull/3772)
- fix(frontend): the eight other languages catch up with the card and the picture switch [`#3770`](https://github.com/gradido/gradido/pull/3770)
- feat(frontend): show other members' faces beside the bookings they share [`#3769`](https://github.com/gradido/gradido/pull/3769)
- feat(backend): let a booking list carry other members pictures [`#3768`](https://github.com/gradido/gradido/pull/3768)
- feat(frontend): a switch for showing the picture to other members [`#3767`](https://github.com/gradido/gradido/pull/3767)
- feat(frontend): mark a booking that was paid with a thank you card [`#3766`](https://github.com/gradido/gradido/pull/3766)
- fix(backend): forget earlier typos as soon as the right pin is typed [`#3765`](https://github.com/gradido/gradido/pull/3765)
- fix(frontend): take out the pin autofocus, and say why in its place [`#3764`](https://github.com/gradido/gradido/pull/3764)
- fix(frontend): put the cursor in the pin field, and keep the balance current [`#3763`](https://github.com/gradido/gradido/pull/3763)
- fix(frontend): give the pin dialog one set of buttons, and say "send" [`#3762`](https://github.com/gradido/gradido/pull/3762)
- fix(frontend): make the till screens readable, and the receipt fit both readers [`#3761`](https://github.com/gradido/gradido/pull/3761)
- feat(frontend): name the scanned card at the till [`#3760`](https://github.com/gradido/gradido/pull/3760)
- fix(frontend): the first-login window reached the wrong people, twice over [`#3759`](https://github.com/gradido/gradido/pull/3759)
- feat(backend): 3249 feature editable alias nutzername [`#3645`](https://github.com/gradido/gradido/pull/3645)
- fix(database): let bigint columns keep their value [`#3758`](https://github.com/gradido/gradido/pull/3758)
- fix(backend): compare the pin the way this house compares passwords [`#3757`](https://github.com/gradido/gradido/pull/3757)
- fix(frontend): let go of the block wish, and of the card that is gone [`#3756`](https://github.com/gradido/gradido/pull/3756)
- feat(frontend): let a blocked card be unblocked, and ask before blocking [`#3755`](https://github.com/gradido/gradido/pull/3755)
- fix(frontend): stop telling the browser a pin is a password [`#3754`](https://github.com/gradido/gradido/pull/3754)
- fix(backend): make the payment request a validated args type [`#3753`](https://github.com/gradido/gradido/pull/3753)
- feat(frontend): print one thank you card at its real size [`#3752`](https://github.com/gradido/gradido/pull/3752)
- fix(frontend): send card amounts as strings, and let a pin be checked [`#3751`](https://github.com/gradido/gradido/pull/3751)
- test(frontend): cover the card settings, pin and all [`#3750`](https://github.com/gradido/gradido/pull/3750)
- fix(frontend): repair the pin field and cover the card payment page [`#3749`](https://github.com/gradido/gradido/pull/3749)
- feat(backend): the thank you card, from printing it to paying with it [`#3748`](https://github.com/gradido/gradido/pull/3748)
- fix(frontend): let the profile page send button carry its own width [`#3747`](https://github.com/gradido/gradido/pull/3747)
- fix(frontend): stop the profile page send button spanning the whole card [`#3746`](https://github.com/gradido/gradido/pull/3746)
- feat(frontend): send Gradido straight from the profile page [`#3745`](https://github.com/gradido/gradido/pull/3745)
- feat(frontend): a tick box for the word above the contact lines [`#3744`](https://github.com/gradido/gradido/pull/3744)
- feat(frontend): contact lines on the Gradido card, and a live preview [`#3743`](https://github.com/gradido/gradido/pull/3743)
- fix(frontend): make the small hints small, with the class that exists [`#3742`](https://github.com/gradido/gradido/pull/3742)
- fix(frontend): make "send Gradido" a heading, not one half of a divided line [`#3741`](https://github.com/gradido/gradido/pull/3741)
- fix(frontend): keep the card address on the card, and ask for a user name first [`#3740`](https://github.com/gradido/gradido/pull/3740)
- feat(frontend): serve the gradido address at /u/:alias [`#3739`](https://github.com/gradido/gradido/pull/3739)
- feat(frontend): the navigation bar shows the Gradido address [`#3738`](https://github.com/gradido/gradido/pull/3738)
- feat(frontend): the recipient field understands a Gradido address [`#3737`](https://github.com/gradido/gradido/pull/3737)
- feat(frontend): the cheque carries the picture and the address, the card gets a sheet [`#3736`](https://github.com/gradido/gradido/pull/3736)
- feat(frontend): the Gradido card as a printable PNG [`#3735`](https://github.com/gradido/gradido/pull/3735)
- fix(frontend): size the first picture before it is painted [`#3734`](https://github.com/gradido/gradido/pull/3734)
- feat(frontend): let members set their own profile picture [`#3733`](https://github.com/gradido/gradido/pull/3733)
- chore(release): v2.10.1 [`#3732`](https://github.com/gradido/gradido/pull/3732)

#### [v2.10.1](https://github.com/gradido/gradido/compare/v2.10.0...v2.10.1)

> 14 August 2026

- feat(frontend): make the cheque visible where a link is handed out [`#3730`](https://github.com/gradido/gradido/pull/3730)
- feat(backend): count any activity for Gradido as common good [`#3729`](https://github.com/gradido/gradido/pull/3729)
- feat(admin): offer the starting bonus cheque in the contribution links [`#3728`](https://github.com/gradido/gradido/pull/3728)
- feat(frontend): download a transaction link as a printable thank-you cheque [`#3727`](https://github.com/gradido/gradido/pull/3727)
- fix(admin): name the icon-only buttons in the moderation table [`#3726`](https://github.com/gradido/gradido/pull/3726)
- refactor(admin): remove the orphaned EditCreationFormular [`#3725`](https://github.com/gradido/gradido/pull/3725)
- fix(admin): open the message panel for moderator-entered contributions [`#3724`](https://github.com/gradido/gradido/pull/3724)
- feat(admin): clear or fill the whole Crea checklist in one click [`#3723`](https://github.com/gradido/gradido/pull/3723)
- fix(frontend): let disabled input fields follow the dark mode [`#3722`](https://github.com/gradido/gradido/pull/3722)
- feat(frontend): complete the matching texts in the other eight languages [`#3721`](https://github.com/gradido/gradido/pull/3721)
- docs(other): warn that deploy defaults take effect one run later [`#3720`](https://github.com/gradido/gradido/pull/3720)
- fix(other): default MATCHING_ACTIVE in the deploy instead of on every server [`#3719`](https://github.com/gradido/gradido/pull/3719)
- fix(other): stop the matching flag from breaking the deploy [`#3718`](https://github.com/gradido/gradido/pull/3718)
- feat(frontend): add the matching pages, map and list behind MATCHING_ACTIVE [`#3717`](https://github.com/gradido/gradido/pull/3717)
- feat(backend): let members publish matching entries to the GMS [`#3716`](https://github.com/gradido/gradido/pull/3716)
- fix(workflow): let the bare-metal deploy test clone the repo it runs in [`#3715`](https://github.com/gradido/gradido/pull/3715)
- feat(backend): move crea's chat window from openai to claude [`#3714`](https://github.com/gradido/gradido/pull/3714)
- feat(admin): group crea's contribution checklist by resubmission [`#3712`](https://github.com/gradido/gradido/pull/3712)
- fix(admin): do not let the crea settings page save a form it has not read [`#3713`](https://github.com/gradido/gradido/pull/3713)
- perf(backend): drop two writes and a filter the creation-group paths never needed [`#3710`](https://github.com/gradido/gradido/pull/3710)
- chore(other): drop the dead browsers from the build target [`#3709`](https://github.com/gradido/gradido/pull/3709)
- feat(other): bring eight fork-only fixes into the main repository [`#3708`](https://github.com/gradido/gradido/pull/3708)
- chore(release): v2.10.0 [`#3707`](https://github.com/gradido/gradido/pull/3707)

#### [v2.10.0](https://github.com/gradido/gradido/compare/v2.9.0...v2.10.0)

> 5 August 2026

- refactor(other): extend agents md [`#3698`](https://github.com/gradido/gradido/pull/3698)
- fix(backend): make the writes that replace a creation-group list survive halfway [`#3706`](https://github.com/gradido/gradido/pull/3706)
- refactor: call them creation groups, not group tags [`#3705`](https://github.com/gradido/gradido/pull/3705)
- fix(backend): sort a contribution's groups where the sorting is actually read [`#3704`](https://github.com/gradido/gradido/pull/3704)
- feat(frontend): offer a reload when the loaded bundle no longer fits the schema [`#3703`](https://github.com/gradido/gradido/pull/3703)
- feat(backend): adopt the hashtags that predate the group field [`#3701`](https://github.com/gradido/gradido/pull/3701)
- feat(backend): group tags — submission field, moderator scope and the groups page [`#3699`](https://github.com/gradido/gradido/pull/3699)
- feat(backend): remember how each participant wants to be addressed [`#3694`](https://github.com/gradido/gradido/pull/3694)
- feat(backend): offer Claude Opus 5 and a fast-mode switch for Crea [`#3693`](https://github.com/gradido/gradido/pull/3693)
- feat(other): let a person-to-person message be longer and keep its line breaks [`#3696`](https://github.com/gradido/gradido/pull/3696)
- fix(backend): stop reading serialization off the clock in the semaphore test [`#3697`](https://github.com/gradido/gradido/pull/3697)
- feat(admin): reserve administrator-only pages and link changes for administrators [`#3692`](https://github.com/gradido/gradido/pull/3692)
- fix(frontend): make form hints readable in dark mode [`#3691`](https://github.com/gradido/gradido/pull/3691)
- refactor(frontend): draw the separators as a line and re-enable no-missing-keys [`#3690`](https://github.com/gradido/gradido/pull/3690)
- fix(frontend): darken the moderator chat message background in dark mode [`#3687`](https://github.com/gradido/gradido/pull/3687)
- feat(backend): add the Crea moderation assistant [`#3688`](https://github.com/gradido/gradido/pull/3688)
- feat(backend): report the running commit at GET /api/version [`#3685`](https://github.com/gradido/gradido/pull/3685)
- feat(admin): bulk-apply a resubmission reminder across a participant's contributions [`#3686`](https://github.com/gradido/gradido/pull/3686)
- fix(workflow): make clear more platform independent [`#3689`](https://github.com/gradido/gradido/pull/3689)
- fix(frontend): remove only the app's own storage blob on logout [`#3684`](https://github.com/gradido/gradido/pull/3684)
- chore(frontend): remove unused files and dependencies [`#3683`](https://github.com/gradido/gradido/pull/3683)
- refactor(frontend): remove dead Argon template remnants [`#3682`](https://github.com/gradido/gradido/pull/3682)
- refactor(frontend): import Bootstrap once instead of components + full package [`#3680`](https://github.com/gradido/gradido/pull/3680)
- feat(frontend): use Bootstrap's native color mode for component surfaces [`#3679`](https://github.com/gradido/gradido/pull/3679)
- refactor(frontend): drop unused flatpickr datepicker library [`#3681`](https://github.com/gradido/gradido/pull/3681)
- fix(auth): complete verifyLogin so token-handoff keeps the GMS/HumHub connection [`#3678`](https://github.com/gradido/gradido/pull/3678)
- chore(release): v2.9.0 [`#3676`](https://github.com/gradido/gradido/pull/3676)
- fix(frontend): remove only the app's own storage blob on logout (#3684) [`#3677`](https://github.com/gradido/gradido/issues/3677)

#### [v2.9.0](https://github.com/gradido/gradido/compare/v2.8.3...v2.9.0)

> 12 July 2026

- fix(frontend): keep the language chosen on the login page after login [`#3675`](https://github.com/gradido/gradido/pull/3675)
- feat(frontend): device-local dark mode (system / light / dark) [`#3674`](https://github.com/gradido/gradido/pull/3674)
- refactor(backend): update gms api for gms_workspace [`#3672`](https://github.com/gradido/gradido/pull/3672)
- fix(frontend): boot-render fixes and brand colours for toasts and buttons [`#3671`](https://github.com/gradido/gradido/pull/3671)
- fix(other): pin mailserver version [`#3673`](https://github.com/gradido/gradido/pull/3673)
- fix(frontend): make the session-timeout modal renew and dismiss reliably [`#3670`](https://github.com/gradido/gradido/pull/3670)
- fix(backend): accept all 10 wallet languages when saving user locale [`#3669`](https://github.com/gradido/gradido/pull/3669)
- fix(frontend): correct send page title (singular Gradido + email) [`#3668`](https://github.com/gradido/gradido/pull/3668)
- fix(other): update module versions, more version pinning [`#3667`](https://github.com/gradido/gradido/pull/3667)
- feat(federation): receive blockchain notifications [`#3643`](https://github.com/gradido/gradido/pull/3643)
- refactor(database): dlt transaction queries and move transactionLinksDecayed into core [`#3661`](https://github.com/gradido/gradido/pull/3661)
- feat(shared-native): interface for using complete transaction in typescript [`#3650`](https://github.com/gradido/gradido/pull/3650)
- feat(shared-native): add c-core enum mapping to TypeScript [`#3649`](https://github.com/gradido/gradido/pull/3649)
- feat(shared-native): add first crypto functions and improve native build system [`#3644`](https://github.com/gradido/gradido/pull/3644)
- feat(shared-native): add pbtools &lt;-&gt; wire mapping [`#3660`](https://github.com/gradido/gradido/pull/3660)
- feat(shared-native): add protobuf related code [`#3659`](https://github.com/gradido/gradido/pull/3659)
- feat(workflow): allow webhook call when start.sh failed [`#3666`](https://github.com/gradido/gradido/pull/3666)
- feat(workflow): stop only own processes from pm2 instead of all [`#3665`](https://github.com/gradido/gradido/pull/3665)
- fix(other): make install.sh more failsafe [`#3664`](https://github.com/gradido/gradido/pull/3664)
- fix(admin): darken hover background for deleted creation rows [`#3663`](https://github.com/gradido/gradido/pull/3663)
- feat(frontend): sprachumschalter als scrollbares Dropdown mit Globus-Icon [`#3662`](https://github.com/gradido/gradido/pull/3662)
- feat(admin): add es/fr/nl/it/tr/ru/pt/el locales [`#3657`](https://github.com/gradido/gradido/pull/3657)
- feat(backend): add es/fr/nl/it/tr/ru/pt/el email locales [`#3656`](https://github.com/gradido/gradido/pull/3656)
- feat(frontend): add greek (el) locale [`#3655`](https://github.com/gradido/gradido/pull/3655)
- feat(frontend): add portuguese (pt) locale [`#3654`](https://github.com/gradido/gradido/pull/3654)
- feat(frontend): add russian (ru) locale [`#3653`](https://github.com/gradido/gradido/pull/3653)
- feat(frontend): add italian locale [`#3652`](https://github.com/gradido/gradido/pull/3652)
- feat(frontend): complete fr, es, nl and tr translations [`#3651`](https://github.com/gradido/gradido/pull/3651)
- feat(frontend): check all locales, en and de with error, others with warn [`#3658`](https://github.com/gradido/gradido/pull/3658)
- feat(database): add dlt transaction queries [`#3648`](https://github.com/gradido/gradido/pull/3648)
- feat(dlt): add validate and decode confirmed transaction [`#3641`](https://github.com/gradido/gradido/pull/3641)
- refactor(dlt): move dlt connector into core [`#3640`](https://github.com/gradido/gradido/pull/3640)
- refactor(backend): move constants into shared [`#3647`](https://github.com/gradido/gradido/pull/3647)
- refactor(dlt): update enums to use same core blockchain enums everywhere [`#3642`](https://github.com/gradido/gradido/pull/3642)
- chore(release): v2.8.3 [`#3639`](https://github.com/gradido/gradido/pull/3639)
- fix(frontend): email send form [`#3638`](https://github.com/gradido/gradido/pull/3638)
- chore(release): v2.8.2 [`#3637`](https://github.com/gradido/gradido/pull/3637)
- fix(backend): email send [`#3636`](https://github.com/gradido/gradido/pull/3636)
- chore(release): v2.8.1 [`#3635`](https://github.com/gradido/gradido/pull/3635)
- fix(database): fix loop [`#3634`](https://github.com/gradido/gradido/pull/3634)
- chore(release): v2.8.0 [`#3633`](https://github.com/gradido/gradido/pull/3633)
- feat(database): recalculate all balances migration [`#3631`](https://github.com/gradido/gradido/pull/3631)
- refactor(shared-native): update decay algo [`#3632`](https://github.com/gradido/gradido/pull/3632)
...
- chore: release v2.8.3 [`01c7466`](https://github.com/gradido/gradido/commit/01c746661a0f677de9d906d069eec96855cde9d5)
- update changelog [`d7598c7`](https://github.com/gradido/gradido/commit/d7598c7f8ef8315a7e856c32e936218894aa5721)

#### [v2.8.2](https://github.com/gradido/gradido/compare/v2.8.1...v2.8.2)

> 27 May 2026

- chore: release v2.8.2 [`b1d20ae`](https://github.com/gradido/gradido/commit/b1d20aea553e320a7f811d74d66fd4ee11a9c831)
- update changelog [`82820b4`](https://github.com/gradido/gradido/commit/82820b454dcc04e7be030cce1b60e003252f70ca)
- fix recipient email [`bfd2a63`](https://github.com/gradido/gradido/commit/bfd2a63139cddd896839bf874c85ba190aee719f)

#### [v2.8.1](https://github.com/gradido/gradido/compare/v2.8.0...v2.8.1)

> 25 May 2026

- chore: release v2.8.1 [`ad4ce07`](https://github.com/gradido/gradido/commit/ad4ce070172b511c3996b5e08e37aa4107bba626)
- update changelog [`c6a9e2f`](https://github.com/gradido/gradido/commit/c6a9e2faf939ef5b5c6f55f832e8fdc18b5c922d)
- fix bug [`6e5b27b`](https://github.com/gradido/gradido/commit/6e5b27b00e57c490cca74db393c8ecb2261b9b6a)

#### [v2.8.0](https://github.com/gradido/gradido/compare/v2.7.5...v2.8.0)

> 25 May 2026

- refactor(shared): move DecayCalculationType into enum folder [`#3630`](https://github.com/gradido/gradido/pull/3630)
- feat(dht): update inspector and gradido node and gradido blockchain [`#3626`](https://github.com/gradido/gradido/pull/3626)
- feat(frontend): extent senddialog with send email [`#3612`](https://github.com/gradido/gradido/pull/3612)
- feat(backend): calculate decay for blocked gdds by transaction links [`#3624`](https://github.com/gradido/gradido/pull/3624)
- refactor(dlt): update migration for changed gradido blockchain [`#3621`](https://github.com/gradido/gradido/pull/3621)
- feat(frontend): remove short git commit hash from wallet frontend and admin [`#3623`](https://github.com/gradido/gradido/pull/3623)
- refactor(database): replace Decimal with GradidoUnit on entites [`#3618`](https://github.com/gradido/gradido/pull/3618)
- refactor(other): improve GradidoUnit, replace many Decimal with GradidoUnit [`#3616`](https://github.com/gradido/gradido/pull/3616)
- refactor(shared-native): update decay algorithmus [`#3619`](https://github.com/gradido/gradido/pull/3619)
- feat(shared): add GradidoUnit and helper classes [`#3620`](https://github.com/gradido/gradido/pull/3620)
- fix(workflow): fix shared-native build on windows [`#3617`](https://github.com/gradido/gradido/pull/3617)
- feat(shared): add shared-native workspace and use it [`#3614`](https://github.com/gradido/gradido/pull/3614)
- refactor(admin): update openai packet [`#3615`](https://github.com/gradido/gradido/pull/3615)
- fix(dlt): mainly updates in gradido node [`#3611`](https://github.com/gradido/gradido/pull/3611)
- chore(release): v2.7.5 [`#3610`](https://github.com/gradido/gradido/pull/3610)
